...
The [Local Harness source preview](/docs/get-started/local-harness/) documents the
runnable composition, durable inspection and recovery commands, and bounded MCP
example. Service HTTP registration and generic run UI remain separate planned
adapters.
