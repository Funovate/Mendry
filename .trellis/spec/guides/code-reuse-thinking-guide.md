...
| Am I copying code from another file? | **STOP** - extract to shared, unless it is a trust-boundary copy (Git/SSH temp-key injection stays inside the owning adapter; do not create `utils`) |
